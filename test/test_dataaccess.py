...
class CciProgressMonitorTest(unittest.TestCase):
    ...
    def test_open_data(self):
        ...
        self.assertEqual(
            [('begin', [('Building Dataset', 0.0, False)]),
             ('update', [('Building Dataset', 0.6666666666666666, False)]),
             ('update', [('Building Dataset', 1.0, False)]),
             ('end', [('Building Dataset', 1.0, True)]),
             ('begin', [('Setting up CCI Chunk Store', 0.0, False)]),
             ('begin', [('Setting up CCI Chunk Store', 0.0, False),
             ...
             ('update', [('Setting up CCI Chunk Store', 0.22222222222222218, False),
             ...
             ('end', [('Setting up CCI Chunk Store', 0.22222222222222218, False),
                      ('Setting up remote chunk store', 0.2222222222222222, False),
                      ('Getting dimension data', 0.3333333333333333, False),
                      ('Getting variable data', 0.6666666666666666, False),
                      ('Fetching feature list', 1.0, True)]),
             ('update', [('Setting up CCI Chunk Store', 0.3333333333333333, False),
                         ('Setting up remote chunk store', 0.3333333333333333, False),
                         ('Getting dimension data', 0.5, False),
                         ('Getting variable data', 1.0, False)]),
             ('end', [('Setting up CCI Chunk Store', 0.3333333333333333, False),
                      ('Setting up remote chunk store', 0.3333333333333333, False),
                      ('Getting dimension data', 0.5, False),
                      ('Getting variable data', 1.0, True)]),
             ('begin', [('Setting up CCI Chunk Store', 0.3333333333333333, False),
                        ('Setting up remote chunk store', 0.3333333333333333, False),
                        ('Getting dimension data', 0.5, False),
                        ('Getting variable data', 0.0, False)]),
             ('begin', [('Setting up CCI Chunk Store', 0.3333333333333333, False),
             ...
             ('update', [('Setting up CCI Chunk Store', 0.5, False),
             ...
             ('update', [('Setting up CCI Chunk Store', 0.5833333333333333, False),
             ...
             ('end', [('Setting up CCI Chunk Store', 0.5833333333333333, False),
                      ('Setting up remote chunk store', 0.5833333333333334, False),
                      ('Getting dimension data', 0.875, False),
                      ('Getting variable data', 0.75, False),
                      ('Building Dataset', 1.0, True)]),
             ('update', [('Setting up CCI Chunk Store', 0.611111111111111, False),
             ...
             ('update', [('Setting up CCI Chunk Store', 0.6388888888888888, False),
             ...
             ('update', [('Setting up CCI Chunk Store', 0.6666666666666666, False),
                         ('Setting up remote chunk store', 0.6666666666666666, False),
                         ('Getting dimension data', 0.9999999999999999, False),
                         ('Getting variable data', 1.0, False)]),
             ('end', [('Setting up CCI Chunk Store', 0.6666666666666666, False),
                      ('Setting up remote chunk store', 0.6666666666666666, False),
                      ('Getting dimension data', 0.9999999999999999, False),
                      ('Getting variable data', 1.0, True)]),
             ('end', [('Setting up CCI Chunk Store', 0.6666666666666666, False),
             ...
             ('update', [('Setting up CCI Chunk Store', 0.8333333333333333, False),
                         ('Setting up remote chunk store', 0.8333333333333334, False)]),
             ('update', [('Setting up CCI Chunk Store', 0.9999999999999998, False),
                         ('Setting up remote chunk store', 1.0, False)]),
             ('end', [('Setting up CCI Chunk Store', 0.9999999999999998, False),
                      ('Setting up remote chunk store', 1.0, True)]),
             ('end', [('Setting up CCI Chunk Store', 0.9999999999999998, True)])],
            self.observer.calls)
